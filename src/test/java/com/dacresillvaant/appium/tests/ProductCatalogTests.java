...
public class ProductCatalogTests extends BaseTest {
    ...
    @Test(testName = "Should display product catalog on app launch")
...
//      expect
    ...
    @Test(testName = "Should display at least one product")
...
//      expect
    ...
    @Test(testName = "Should display non-empty product names")
...
//      expect
    ...
    @Test(testName = "Should display non-empty product prices")
